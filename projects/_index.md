...
All active work organized by domain.
...
## What lives here
- Project plans, roadmaps, session handoffs
- STATUS.md per project (completion status)
- Build notes, architecture decisions

## What doesn't live here
- Raw research (use `wiki/`)
- Finished deliverables (use `content/`)
- Recurring ops (use `ops/`)

## Navigation
Check `_index.md` before searching this folder manually.
